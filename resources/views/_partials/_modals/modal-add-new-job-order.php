          ...
          <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              <!-- <input type="text" id="bs-rangepicker-single" name="modalDate" class="form-control" /> -->
                <input type="date"  id="bs-rangepicker-single" class="form-control invoice-date" placeholder="DD/MM/YYYY" value="<?php echo date("DD/MM/YYYY"); ?>"/>
          ...
          <div class="col-12 col-md-6">
           ...
           <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
              ...
              <label for="modalVehicleType">Vehicle Model</label>
            </div>
          </div>
             <div class="col-12 col-md-6">
            <div class="form-floating form-floating-outline">
