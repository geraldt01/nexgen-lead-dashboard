...
<div class="invoice-print p-4">
  ...
  <div class="table-responsive">
    <table class="table m-0 border-black">
        ...
        @endforeach
        <tr>
          <th colspan="5"><strong>LABOR</strong></th>
        </tr>
        <tr>
      ...
      @foreach($jobOrderLaborSelected as $klabor => $labor)
        <tr>
          ...
          <td class="text-center">{{$labor->labor_qty}}</td>
          <td class="text-right">{{$labor->labor_price}}</td>
          <td class="text-right">${{$labor->labor_qty * $labor->labor_price}}</td>
        </tr>
      @endforeach
        <tr>
          <td colspan="3"></td>
          <td class="text-right"><b>Total</b></td>
          <td class="text-right"><b>6,000.00</b></td>
        </tr>
        <tr>
          <td colspan="5"></td>
        </tr>
         <tr>
          <th colspan="5"><strong>PARTS & SERVICES</strong></th>
        </tr>
        <tr>
          <th style="width: 4%"><strong>NO</strong></th>
          <th>SERVICE</th>
         ...
         @foreach($jobOrderPartSelected as $kpart => $part)
            <tr>
              ...
              <td class="text-center">{{$part->part_qty}}</td>
              <td class="text-right">{{$part->part_price}}</td>

              <td class="text-right">${{$part->part_qty * $part->part_price}}</td>
            </tr>
          @endforeach
        <tr>
          <td colspan="3"></td>
    ...
    <table class="table m-0 " style="border-top: none;border-left: 1px solid rgba(76, 78, 100, 0.5);border-right: 1px solid rgba(76, 78, 100, 0.5);">
        <tr  style="border-top: none;border-left: 1px solid rgba(76, 78, 100, 0.5);border-right: 1px solid rgba(76, 78, 100, 0.5);">
          ...
          <td class="text-end px-4 py-3" style="width: 10%;vertical-align: top;">
          ...
          <td class="text-end px-4 py-3" style="width: 10%;vertical-align: top;">
            <p class="mb-2"><b>$154.25</b></p>
            <p class=" mb-2">$00.00</p>
            <p class=" mb-2"><b>$50.00</b></p>
            <p class="mb-2"><b>$50.00</b></p>
            <p class="mb-2"><b>$204.25</b></p>
          </td>
        </tr>
    </table>
