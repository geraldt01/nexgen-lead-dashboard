...
Route::get('/app/job-order/{job_order_id}', [InvoiceEdit::class, 'index'])->name('app-invoice-edit');
Route::get('/app/save-job-order-item/{job_order_id}', [InvoiceEdit::class, 'saveJobOrderItem']);
Route::get('/app/get-job-order-item-price/{job_order_id}', [InvoiceEdit::class, 'getJobOrderItemprice']);

Route::get('/app/job-order/preview/{job_order_id}', [InvoicePreview::class, 'index'])->name('app-invoice-preview');

Route::get('/app/job-order/print/{job_order_id}', [InvoicePrint::class, 'index'])->name('app-invoice-print');
