...
function saveJobOrder() {
    ...
    var modalStatus = document.getElementById("modalStatus").value;
...
function addNewCar() {
  ...
  $.ajax({
    type: "get",
    url: '/app/add-new-car/',
    data:  {owner_id:owner_id,modalPlateNumber:modalPlateNumber,modalManufacturer:modalManufacturer,modalVehicleModel:modalVehicleModel,modalMileage:modalMileage },
    success: function (result) {
