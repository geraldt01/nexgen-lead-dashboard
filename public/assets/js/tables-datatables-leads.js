      ...
      if (newRecord) {
        newRecord.addEventListener('click', function () {
          ...
          (offCanvasElement.querySelector('.dt-full-name').value = ''),
            (offCanvasElement.querySelector('.dt-linkedin_url').value = ''),
...
$(function () {
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      ...
      ajax: '/json/lead-dashboard/', // JSON file to add data
      ...
      columnDefs: [
        ...
        },
        {
        ...
        },
         {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $linkedin_url = full['linkedin_url'];
            return $linkedin_url;
          }
        },
        {
...

 {
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">RTG Leads</h5>');
  }
  ...
  fv.on('core.form.valid', function () {
    var $new_name = $('.add-new-record .dt-full-name').val(),
      $new_post = $('.add-new-record .dt-linkedin_url').val(),
